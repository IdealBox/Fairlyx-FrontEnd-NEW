...
import validateEmail from "../../../src/utils/funtions/form-validation"
...
function SignUp() {
  ...
  return (
    <div className='w-[300px] text-[14px] flex gap-5 flex-col mx-auto'>
      ...
      <div>Sign up with Open account</div>
      <div className='grid grid-cols-2 gap-2'>
        ...
        <button className='border border-gray-300 font-semibold p-3 rounded-xl text-black w-full'>AppleID</button>
      </div>
