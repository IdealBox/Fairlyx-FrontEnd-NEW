...
function OtpScreen() {
  ...
  return (
    <div className='w-[300px] text-[14px] flex gap-5 flex-col mx-auto'>
      ...
      <OtpInput value={otp} onChange={handleChange} className="grid grid-cols-4 w-full" inputStyle={"p-3 rounded-xl !w-16 !h-16 text-3xl border "} numInputs={otp_input_count} separator={<span>-</span>} />
