	...
	return (
		<div className="w-full p-4 sm:p-8">
			<div>
				...
				<div className="py-8 w-full bg-white dark:bg-app-neutral-700 flex gap-y-8 flex-col lg:flex-row lg:divide-x divide-gray-100 dark:divide-gray-800 rounded-lg overflow-hidden sm:p-4 lg:p-8">
