...
const ProTips = () => {
    return (
        <div>
            <div className="bg-white p-6 max-w-fit max-h-fit rounded-lg overflow-hidden shadow-lg">
                ...
                <div className="mx-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-8">
                        ...
                        <div className="flex">
                            <div className="bg-gray-200 rounded-full w-16 h-16 me-3">
                                <div className="m-3">
                                    <BsArrowRightShort size='2.5rem' />
                                </div>
                            </div>
                            <div className="">
                                <p className='font-semibold'>Asset use guidelines</p>
                                <div className="flex mt-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-8">
                        <div className="flex">
                            <div className="outline outline-gray-200 rounded-full w-16 h-16 me-3">
                                <div className="m-5">
                                    <LiaPencilRulerSolid size='1.5rem' />
                                </div>
                            </div>
                            <div className="">
                                <p className='font-semibold'>Exclusive downloads</p>
                                <div className="flex mt-2">
                                    <span className=''></span>
                                    <div className="flex outline outline-gray-200 outline-1 py-1 rounded">
                                        <img className="object-cover w-5 h-5 rounded mr-1" src="/logo192.png" alt="" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-8">
                        ...
                        <div className="flex">
                            <div className="outline outline-gray-200 rounded-full w-16 h-16 me-3">
                                <div className="m-5">
                                    <MdOutlineLibraryAddCheck size='1.5rem' />
                                </div>
                            </div>
                            <div className="">
                                <p className='font-semibold'>Life & work updates</p>
                                <div className="flex mt-2">
                                    <span className=''></span>
                                    <div className="flex outline outline-gray-200 outline-1 py-1 rounded">
                                        <img className="object-cover w-5 h-5 rounded mr-1" src="/logo192.png" alt="" />
