...
function OtpScreen({ setAuthScreen }: AuthScreenTypes) {
  ...
  return (
    <div className='w-[300px] text-[14px] flex gap-5 flex-col mx-auto'>
      ...
      <OtpInput value={otp} onChange={handleChange} className="grid grid-cols-4 w-full" inputStyle={"p-3 rounded-xl font-bold outline-none focus:border-gray-300 !w-16 caret-primary-1 !h-16 text-3xl focus:border-2 "} numInputs={otp_input_count} />
