    ...
    <>
      ...
      <tr className="sm:hidden">
        <td>
          ...
          >
            ...
            {searchParams.get("pt") === "market" || searchParams.get("tab") === "released" ? (
      ...
      >
        <td className="align-top text-gray-200 px-4">
          <input type="checkbox" className="h-5 aspect-square bg-transparent" />
        </td>
        ...
        <td className="invisible absolute group-hover/item:visible edit gap-4 mt-9 -ml-14 z-40 left-1/2">
          <div className="flex items-center justify-center gap-4">
            ...
            <button onClick={handleShowSubMenu} className="focus:outline-none">
