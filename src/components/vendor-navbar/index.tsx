    ...
    return (
        <div className='flex w-full bg-white dark:bg-app-neutral-700 items-center justify-between px-7 py-3'>
            ...
            <div className="flex">
                ...
                <div className={`sm:bg-gray-100 dark:bg-app-neutral-600 ${searchMenu || searchText.length > 0 ? "border-2 " : ""} p-1 border-primary-1 hidden z-[1] sm:flex items-center rounded-xl`}>
                    ...
                    }} className={`bg-transparent p-2 rounded-2xl hidden dark:caret-gray-200 sm:flex w-[250px] outline-none`} placeholder="Search or type a command" />
                    {searchMenu || searchText.length === 0 ? <div className="font-[700] bg-white dark:bg-app-neutral-800 dark:text-gray-200 hidden sm:flex rounded-lg px-6 py-[5px]">F</div> : <RiCloseCircleFill onClick={() => {
                        setSearchText("")
            ...
            {!searchMenu && <div className="flex items-center gap-6">
                ...
                <div className="flex">
                    ...
                    <MessageIcon className=" dark:text-gray-200" />
                </div>
                <div className="flex">
                    <div className="w-3 h-3 absolute border-2 ml-3 border-white dark:border-app-neutral-700 rounded-full bg-orange-600"></div>
