...
const ProductStatTable = () => {
  const [searchParams] = useSearchParams(); // Get product tab query parameters
  ...
  return (
    <table className="table table-auto mt-5 w-full">
      <thead className="text-left  text-gray-500 dark:text-gray-400">
            ...
            <th>
              {searchParams.get("pt") === "traffic-sources" ? (
                <div className="flex text-xs justify-between items-center">
                  ...
                  <div className="grid ml-auto gap-3 grid-cols-2 lg:grid-cols-5">
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-secondary-1 rounded-md"></div>
                      <span>Market</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-secondary-2 rounded-md"></div>
                      <span>Social media</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-secondary-3 rounded-md"></div>
                      <span>Direct</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-secondary-4 rounded-md"></div>
                      <span>U18</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2  bg-secondary-5 rounded-md"></div>
                      <span>Others</span>
                    </div>
                  </div>
                </div>
        ...
        <tr className="sm:hidden table-row [&>*]:py-3 [&>*]:font-light">
          <th>
            {searchParams.get("pt") === "traffic-sources" ? (
              <div className="flex text-xs justify-between items-center">
                <div className="grid ml-auto gap-3 grid-cols-5">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-secondary-1 rounded-md"></div>
                    <span>Market</span>
                  </div>
