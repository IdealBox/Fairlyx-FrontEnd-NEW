...
function DashboardSideBar() {
	...
	const income = ['earning', 'refunds', 'payouts', 'statements'];

	const customer = ['overview', 'customer-list'];
	const navigate = useNavigate();
	return (
		<div className="sm:flex h-full overflow-y-scroll scrollbar-none bg-white dark:bg-app-neutral-700 xl:min-w-[340px] hidden xl:max-w-[340px] p-6 gap-1 flex-col">
